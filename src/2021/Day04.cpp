...
namespace y2021::day04
{
  ...
  REGISTER_DAY(2021, Day04, Game, int);

  REGISTER_TEST_EXAMPLE(2021, Day04, ExampleInput, 1, 4512);
  REGISTER_TEST(2021, Day04, Input, 1, 54275);
  REGISTER_TEST_EXAMPLE(2021, Day04, ExampleInput, 2, 1924);
  REGISTER_TEST(2021, Day04, Input, 2, 13158);
