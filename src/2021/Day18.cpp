...
namespace y2021::day18
{
  ...
  REGISTER_DAY(2021, Day18, std::vector<Node>, int);

  REGISTER_TEST_EXAMPLE(2021, Day18, ExampleInput, 1, 4140);
  REGISTER_TEST(2021, Day18, Input, 1, 4137);
  REGISTER_TEST_EXAMPLE(2021, Day18, ExampleInput, 2, 3993);
  REGISTER_TEST(2021, Day18, Input, 2, 4573);
