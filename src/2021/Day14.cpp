...
namespace y2021::day14
{
  ...
  REGISTER_DAY(2021, Day14, Data, int64_t);

  REGISTER_TEST_EXAMPLE(2021, Day14, ExampleInput, 1, 1588);
  REGISTER_TEST(2021, Day14, Input, 1, 4517);
  REGISTER_TEST_EXAMPLE(2021, Day14, ExampleInput, 2, 2188189693529);
  REGISTER_TEST(2021, Day14, Input, 2, 4704817645083);
