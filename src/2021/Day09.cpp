...
namespace y2021::day09
{
  REGISTER_DAY(2021, Day09, Array2D<int>, int);

  REGISTER_TEST_EXAMPLE(2021, Day09, ExampleInput, 1, 15);
  REGISTER_TEST(2021, Day09, Input, 1, 478);
  REGISTER_TEST_EXAMPLE(2021, Day09, ExampleInput, 2, 1134);
  REGISTER_TEST(2021, Day09, Input, 2, 1327014);
  ...
  OUTPUT1(input)
  {
    ...
    {
      Index2D indices[4]{
        {index.x - 1, index.y}, {index.x, index.y - 1}, {index.x + 1, index.y}, {index.x, index.y + 1}};
      bool all = true;
