...
namespace y2021::day11
{
  ...
  REGISTER_DAY(2021, Day11, Array2D<int>, int);

  REGISTER_TEST_EXAMPLE(2021, Day11, ExampleInput, 1, 1656);
  REGISTER_TEST(2021, Day11, Input, 1, 1667);
  REGISTER_TEST_EXAMPLE(2021, Day11, ExampleInput, 2, 195);
  REGISTER_TEST(2021, Day11, Input, 2, 488);
