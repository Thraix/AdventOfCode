...
namespace y2021::day24
{
  ...
  REGISTER_DAY(2021, Day24, std::vector<Instruction>, int64_t);

  REGISTER_TEST(2021, Day24, Input, 1, 99919765949498);
  REGISTER_TEST(2021, Day24, Input, 2, 24913111616151);
