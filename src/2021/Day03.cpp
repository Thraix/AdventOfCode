...
namespace y2021::day03
{
  REGISTER_DAY(2021, Day03, std::set<std::string>, int);

  REGISTER_TEST_EXAMPLE(2021, Day03, ExampleInput, 1, 198);
  REGISTER_TEST(2021, Day03, Input, 1, 2498354);
  REGISTER_TEST_EXAMPLE(2021, Day03, ExampleInput, 2, 230);
  REGISTER_TEST(2021, Day03, Input, 2, 3277956);
