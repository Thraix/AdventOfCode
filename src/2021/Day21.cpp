...
namespace y2021::day21
{
  ...
  REGISTER_DAY(2021, Day21, std::vector<int>, int64_t);

  REGISTER_TEST_EXAMPLE(2021, Day21, ExampleInput, 1, 739785);
  REGISTER_TEST(2021, Day21, Input, 1, 503478);
  REGISTER_TEST_EXAMPLE(2021, Day21, ExampleInput, 2, 444356092776315);
  REGISTER_TEST(2021, Day21, Input, 2, 716241959649754);
