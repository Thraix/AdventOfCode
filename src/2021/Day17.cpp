...
namespace y2021::day17
{
  ...
  REGISTER_DAY(2021, Day17, Area, int);

  REGISTER_TEST_EXAMPLE(2021, Day17, ExampleInput, 1, 45);
  REGISTER_TEST(2021, Day17, Input, 1, 2701);
  REGISTER_TEST_EXAMPLE(2021, Day17, ExampleInput, 2, 112);
  REGISTER_TEST(2021, Day17, Input, 2, 1070);
