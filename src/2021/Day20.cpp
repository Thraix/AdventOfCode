...
namespace y2021::day20
{
  ...
  REGISTER_DAY(2021, Day20, Data, int);

  REGISTER_TEST_EXAMPLE(2021, Day20, ExampleInput, 1, 35);
  REGISTER_TEST(2021, Day20, Input, 1, 5203);
  REGISTER_TEST_EXAMPLE(2021, Day20, ExampleInput, 2, 3351);
  REGISTER_TEST(2021, Day20, Input, 2, 18806);

  READ_INPUT(input)
  {
    Data data;
    std::getline(input, data.line);
    std::string str;
    getline(input, str);
