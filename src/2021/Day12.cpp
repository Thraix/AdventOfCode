...
namespace y2021::day12
{
  ...
  REGISTER_DAY(2021, Day12, NodeMap, int);

  REGISTER_TEST_EXAMPLE(2021, Day12, ExampleInput, 1, 10);
  REGISTER_TEST(2021, Day12, Input, 1, 3887);
  REGISTER_TEST_EXAMPLE(2021, Day12, ExampleInput, 2, 36);
  REGISTER_TEST(2021, Day12, Input, 2, 104834);
