...
namespace y2021::day13
{
  ...
  REGISTER_DAY(2021, Day13, Paper, int);

  REGISTER_TEST_EXAMPLE(2021, Day13, ExampleInput, 1, 17);
  REGISTER_TEST(2021, Day13, Input, 1, 716);
  REGISTER_TEST_EXAMPLE(2021, Day13, ExampleInput, 2, 16);
  REGISTER_TEST(2021, Day13, Input, 2, 97);
